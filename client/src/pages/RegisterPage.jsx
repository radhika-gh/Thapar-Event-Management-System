...
export default function RegisterPage() {
  ...
    async function registerUser(ev) {
    ...
    if (!email.endsWith('@thapar.edu')) {
      alert('Please Enter Thapar Email');
      return;
    }
    ...
            password,
          });
          // If registration is successful, alert the user and redirect to login
  ...
  return (
    ...
    <div className="w-80 mt-6">
      <img src="../public/assets/signuppic.jpeg" alt="" className="w-full" />
    </div>
  </div>  
      ...
      <div className= "bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle ">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={registerUser}>
            ...
            <div className= "input">
              ...
              <input type ="email"  placeholder=" Thapar Email" className="input-et" value={email} onChange={ev => setEmail(ev.target.value)}/>
            </div>
